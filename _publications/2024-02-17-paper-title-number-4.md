...
excerpt: 'This paper was accepted and will be published in an EI-indexed journal, which has the greatest influence in the field of China's power industry, where I am the first author. I will translate the complete core content of the paper into English after publishment'
date: 2024-02-17
venue: 'Proceedings of the CSEE'
paperurl: 'http://academicpages.github.io/files/paper3.pdf'
citation: 'Wenrong Wei, Shihong MIAO, et al. (2024). &quot;Paper Title Number 3.&quot; <i>Proceedings of the CSEE</i>. 1(3).'
---
